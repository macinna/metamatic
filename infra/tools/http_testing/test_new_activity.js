...
console.log('🆕 Testing New Activity Flow');
...
const req = https.request(options, (res) => {
    ...
    res.on('end', () => {
        try {
            ...
            if (parsedResponse.creative_names) {
                console.log('\n🎨 Generated Creative Names:');
                parsedResponse.creative_names.forEach((name, index) => {
...
req.on('error', (error) => {
    ...
    console.error('💡 Start the agent with: "Debug MetaMatic Agent" configuration');
});
